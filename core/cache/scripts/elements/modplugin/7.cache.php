<?php  return 'if (!$modx->loadClass(\'hybridauth\', $modx->getOption(\'hybridauth.core_path\', null, $modx->getOption(\'core_path\', null, MODX_CORE_PATH) . \'components/hybridauth/\') . \'model/hybridauth/\', false, true)) {
	return;
}
