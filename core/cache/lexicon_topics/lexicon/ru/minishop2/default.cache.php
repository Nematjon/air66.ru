<?php  return array (
  ...
  'comparison_field_arearoom' => 'Площадь помещения',
  'comparison_field_coolpower' => 'Мощность в режиме охлаждения',
  'comparison_field_dimensioninner' => 'Размер внутреннего блока (ШхВхГ)',
  'comparison_field_dimensionouter' => 'Размер внешнего блока (ШхВхГ)',
  'comparison_field_dopfunction' => 'Дополнительные режимы',
  'comparison_field_dopinfo' => 'Дополнительная информация',
  'comparison_field_drymode' => 'Режим осушение',
  'comparison_field_faza' => 'Фаза',
  'comparison_field_hotpower' => 'Мощность в режиме обогрева',
  'comparison_field_innerdcbl' => 'Уровень шума внутреннего блока',
  'comparison_field_mainfunctions' => 'Основные режимы',
  'comparison_field_maxflow' => 'Максимальный воздушный поток',
  'comparison_field_maxleinght' => 'Макс. длина коммуникаций',
  'comparison_field_otherfunction' => 'Другие функции и особенности',
  'comparison_field_powerforcool' => 'Потребляемая мощность при охлаждении',
  'comparison_field_powerforhot' => 'Потребляемая мощность при обогреве',
  'comparison_field_pyltdu' => 'Пульт ДУ',
  'comparison_field_speedfun' => 'Регулировка скорости вращения вентилятора',
  'comparison_field_timer' => 'Таймер',
  'comparison_field_typecond' => 'Тип кондиционера',
  'comparison_field_typehladogen' => 'Тип хладагена',
  'comparison_field_typetov' => 'Тип товара',
  'ms2_product_arearoom' => 'Площадь помещения',
  'ms2_product_coolpower' => 'Мощность в режиме охлаждения',
  'ms2_product_dimensioninner' => 'Размер внутреннего блока (ШхВхГ)',
  'ms2_product_dimensionouter' => 'Размер внешнего блока (ШхВхГ)',
  'ms2_product_dopfunction' => 'Дополнительные режимы',
  'ms2_product_dopinfo' => 'Дополнительная информация',
  'ms2_product_drymode' => 'Режим осушение',
  'ms2_product_faza' => 'Фаза',
  'ms2_product_hotpower' => 'Мощность в режиме обогрева',
  'ms2_product_innerdcbl' => 'Уровень шума внутреннего блока',
  'ms2_product_mainfunctions' => 'Основные режимы',
  'ms2_product_maxflow' => 'Максимальный воздушный поток',
  'ms2_product_maxleinght' => 'Макс. длина коммуникаций',
  'ms2_product_otherfunction' => 'Другие функции и особенности',
  'ms2_product_powerforcool' => 'Потребляемая мощность при охлаждении',
  'ms2_product_powerforhot' => 'Потребляемая мощность при обогреве',
  'ms2_product_pyltdu' => 'Пульт ДУ',
  'ms2_product_speedfun' => 'Регулировка скорости вращения вентилятора',
  'ms2_product_timer' => 'Таймер',
  'ms2_product_typecond' => 'Тип кондиционера',
  'ms2_product_typehladogen' => 'Тип хладагена',
);